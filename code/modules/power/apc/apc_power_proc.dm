...
/obj/machinery/power/apc/proc/update()
	if(operating && !shorted && !failure_timer)
		...
		playsound(src.loc, 'modular_zubbers/sound/machines/breaker_on.ogg', 50, FALSE) // BUBBER EDIT: Soundening: ORIGNAL: playsound(src.loc, 'sound/machines/terminal/terminal_on.ogg', 50, FALSE)
	else
		area.power_light = FALSE
		area.power_equip = FALSE
		area.power_environ = FALSE
		playsound(src.loc, 'modular_zubbers/sound/machines/breaker_off.ogg', 50, FALSE) // BUBBER EDIT: Soundening: ORIGNAL: playsound(src.loc, 'sound/machines/terminal/terminal_off.ogg', 50, FALSE)
	area.power_change()
